    ...
    <div class="card border-0 shadow">
        ...
        <div class="card-body">
            <blockquote class="blockquote mb-0">
                ...
                <ol>
                    <li>
                        knowledge Base (basis pengetahuan). Jadi kita harus memiliki basis pengetahuan dari keparang seseorang, misal dokter kita membutuhkan data penyakit paru dan gejala-gejala nya.
                    </li>
                    <li>
                        Menentukan Rule(aturan) atau inference Engine untuk memulai penalaran mendapatkan kesimpulan(goals) dari hipotesa(objek) untuk mendapatkan fakta. misalnya penyakit DBD sebagai kesimpulan dan demam sebagai gejala nya.
                    </li>
                    <li>
                        membuat Output(hasil) dalam bentuk solusi dari hasil penalaran. Misalkan penyakit yg di derita migran, maka solusi penanganan nya adalah minum obat ini atau itu.
                    </li>
                </ol>
                <footer class="blockquote-footer">By <cite title="Source Title">Darsih</cite></footer>
            </blockquote>
        </div>
    </div>
</div>